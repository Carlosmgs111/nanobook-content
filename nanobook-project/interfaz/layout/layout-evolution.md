---
id: "0fab834d-a9c8-4cc1-92c1-d8b65072c56f"
...
- `src/content/nanobook-project/interfaz/layout/comunicacion-estado-componentes.md` — explica en detalle cómo se comunican los estados entre TOC, Sidebar y ContentWidthToggle.
- `src/content/nanobook-project/interfaz/tabla-de-contenidos/dataset-estado-toc.md` — profundiza en el cambio de `classList` a `data-is-active` en el TOC.
